...
author: 
  ...
  - PhD. Catalina Suescun (UL), Prof. Fabio Cruz (UL).
date: today
date-format: long
metadata-files:
  - _metadata.yml
...
This document contains the deliverable **D2.3 Mentoring  and peer-collaboration learning reports** of the *Work Package 2 (WP2) Development of a networked portfolio* of the TechTraPlastiCE project.
The scope of this deliverable is to present the mentoring and peer-collaboration activities developed within the TechTraPlastiCE project to strengthen technology transfer and circular economy capacities among partner Higher Education Institutions (HEIs). 
Building on the institutional portfolios created in Deliverables D2.1 and D2.2, the report shifts the focus from mapping institutional capabilities to activating them through collaborative learning, mentoring, and inter-university exchange.

The methodology is based on a participatory, qualitative, and iterative approach combining canvas-based institutional analysis, peer-learning workshops, consortium meetings, and external expert validation. Universities jointly identified strengths, needs, and opportunities for cooperation across areas such as infrastructure, applied research, innovation services, industry engagement, and training. 
This process enabled the detection of complementary institutional profiles and the creation of potential collaboration pathways within the consortium.

A central component of the deliverable is the contribution of the External Advisory Board (EAB), composed of international experts in innovation, entrepreneurship, sustainability, and technology transfer. 
Their recommendations highlighted the importance of long-term strategic coordination, institutional flexibility, and stronger links between academia, industry, and society.
Overall, D2.3 demonstrates how network-based collaboration and mentoring can enhance institutional learning, improve technology transfer practices, and support the development of sustainable innovation ecosystems in the plastics circular economy sector.
...
![Mentoring and peer-collaboration for TechTraplastiCE Project](figures/2.3/D2.3.png){#fig-baseline fig-alt="alt"}
...
As it was presented in D2.1, a key activity was conducted during the consortium meeting held in Chile during November 2025, where the nine partner universities participated in a structured exercise based on the canvas methodology. 
...
This approach aimed to enrich the analytical framework by introducing collaborative and co-creation dynamics as a key dimension of technology transfer processes from the presential meeting made at Chile in Nov. 2025 (See the presentation in the Annex). 

![Presentation on Open Innovation made by the UNS at the General meeting of December 2025](figures/2.3/Open-inno.png){#fig-open width="95%" fig-align="center"}
...
During the second semester of 2025, the members of the EAB made a official presentation to the TechTraPlastiCE consortium on topic related to the technology transfer and Circular Economy.
...
At the monthly general consortium of TechTraPlastiCE of Oct. 2025, Prof. Jaime presented her expertise research on innovation project management, knowledge transfer processes, entrepreneurship, and intellectual property as illustrated @fig-UIS. 
...
![Presentation of Prof. Astrid Jaime to the TechTraPlastiCE Consortium on general meeting of Oct. 2025](figures/2.3/Astrid-00.png){#fig-id fig-alt="alt"}
...
![Presentation of Ex-Prof. Veronical Bucala to the TechTraPlastiCE Consortium on general meeting of Dec. 2025](figures/2.3/Veronica-00.png){#fig-id fig-alt="alt"}
...
On the monthly general meeting of TechTraPlastiCE in Dec. 2025, she shared to the consortium her experience on the key role in strengthening the link between science and industry and promoting technology transfer processes. 
...
:::{}
![Meeting of TechTraPlastiCE at Chile. Nov. 2025](figures/2.3/Chile-00.jpg){#fig-chile width="90%"}
...
:::{#fig-matchs layout="[[50,50],[100]]"}
![Mentoring-based matching](figures/2.3/Match-00.png){#fig-match0 width="300px" fig-align="center"}


![Complementarity-based matching](figures/2.3/Match-01.png){#fig-match1 width="300px" fig-align="center"}

![Affinity-based matching](figures/2.3/Match-02.png){#fig-match2 width="300px" fig-align="center"}
...
\includepdf[landscape=false,  delta=2 2, frame=true,  nup=2x3, pagecommand*={\pagestyle{fancy} \section{Presentation of Open Innovation and presentation of Véronica Bucala and Mara Volpe on General Meeting of Dec. 17/2025}}, 
