...
The timeline for respond the questionnaires was between **September 2026 - Nov 2026**.
...
This includes visual records of the completed canvas (@fig-canva1) by each HEI's, which capture collective reflections (@fig-canva2 and @fig-canva3) on the institutional insights, and identified opportunities for collaboration. 
...
![Example of canva discussed at the consortium meeting in Chile in Nov. 2026](figures/2.1/Canva-00.jpg){#fig-canva1 width="60%" fig-align="center"}

![Workshop developed by each HEI's](figures/2.1/Canva-01.jpg){#fig-canva2 width="60%" fig-align="center"}

![Feedback made by the consortium meeting at Chile in Nov. 2026](figures/2.1/Canva-02.jpg){#fig-canva3 width="60%" fig-align="center"}
