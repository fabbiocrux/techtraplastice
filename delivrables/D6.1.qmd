...
The Université de Lorraine (UL), in collaboration with selected partners will establish a quality committee that validate the criteria, indicators, and procedures to guide the project’s development and ensure high standards of quality.
...
This internal structure is entrusted with the revision and continuous improvement of the project quality of the deliverables of the project, and responsibilities to be adhered to throughout the project lifecycle in theirs tasks. 
...
1. *Step 5*: Managers of each university will collect, synthethise and share the results with the task leaders.
...
In that sense, based on the timetable plan and on the Logical Framework Matrix the proposal, the quality committe will help to assess expectations, level of progress and difficulties of each task and milestones.  
...
table <- 
tribble(
~People, ~Organisation, ~Profile, ~Contact,

"Maria José Zapata", 
"Department of Business Administration, School of Business, Economics and Law
University of Gothenburg - Sweden", 
"Associate Professor at the University of Gothenburg.
Her scholarship is rooted in examining how public-private collaborations and grassroots initiatives shape environmental sustainability in urban contexts.
...
Her research has been widely published in leading journals such as Habitat International, Environment and Urbanization, and Accounting, Organizations and Society.", 
"- Website: https://www.gu.se/en/about/find-staff/mariajosezapatacampus
- ORCID: https://orcid.org/0000-0002-2271-0148
",

"Ferran Giones",  
"Institute of Entrepreneurship and Innovation Science (ENI)
Unversity of Sttutgart - Germany", 
"Associate Professor and Deputy Director at the Institute of Entrepreneurship and Innovation Science (ENI), University of Stuttgart. He holds a BBA and MBA from ESADE Business School and earned his Ph.D. from La Salle – Ramon Llull University in Barcelona. 

Before entering academia, he built his expertise in strategy consulting and international project management, later serving as Assistant Professor in Technology Entrepreneurship at the University of Southern Denmark. He leads teaching in Technology Entrepreneurship.",
"- Website: https://www.eni.uni-stuttgart.de/en/institute/team/Giones/ 
- ORCID: https://orcid.org/0000-0002-1927-6918
",

"Astrid Jaime",
"Associate researcher, Industrial Engineering
Corporación Universitaria Minuto de Dios - Colombia",
"PhD in Industrial Engineering, with emphasis on Knowledge Management in Research. 
Experience in Management of Technology, Knowledge Management and general issues related to technological innovation. At present, working as Associate Proffesor at the University El Bosque. 
...
"- ResearchGate: https://www.researchgate.net/lab/Astrid-Jaime-Lab 
- ORCID: https://orcid.org/0000-0003-2938-2439
",
...
She have developed and implementated sustainable transformation projects with the a triple botton line impact analysis, evaluating social, environmental and economic effects to promote sustainable practices and innovative solutions.",
"- Website: https://cyclus.com.ar/",


"Carolina Pizarro *",
"Sustainability Manager at Alimentos y Bebidas de Chile A.G.",
"She leads the sustainability strategy at Alimentos y Bebidas de Chile AG, coordinating circular economy initiatives with 28 major companies. She has experience in waste valorization, sustainable packaging, and biofuels. She can provide a strong technical and operational perspective to strengthen industry-academia collaboration within the project.",
"- Website: https://www.abchile.cl/nosotros",


"Paula Juarez *",
"National University of Quilmes (UNQ) and an Senior Researcher at the Institute of Studies on Science and Technology (IESCT-UNQ)",
"Paula Juarez currently works at the Institute for the Study of Science and Technology, National University of Quilmes (Argentina). Paula does research in Science and Technology Policy for Inclusive Sustainable Development, Water, Food and Climate Policy and Circular Economy. Her perspective of research is socio-technical and interdisciplinary. She works with non-academic actors to improve development strategies and policies in Argentina, Gran Chaco Americano and the world.",
"- ORCID: https://orcid.org/0000-0002-8955-2068",


"Lucas Dardo Becerra *",
"Regular Professor of International Economics at the National University of Quilmes (UNQ). He is a Visiting Professor at the Sorbonne Nouvelle University in Paris, where he teaches courses on social studies of science and technology and development and technology policy",
"Lucas has developed a strong expertise in inclusive and sustainable development, science, technology and innovation policy, and circular economy. He has participated in numerous research projects, published academic papers, conducted field work, and provided strategic inputs for decision making in Latin America and beyond. He is currently the Director of the R\\&D project on public policies of science, technology and innovation and the Coordinator of the Open Lab of Innovation and Circular Economy.",
" - ORCID: https://orcid.org/0000-0001-6514-3182",
)
...
table %>%
  ...
  kbl("latex", booktabs = T, escape = F, align = c('l','l','l','l'), longtable = T,
   ...
   footnote(symbol = c("To be confirmed"))
...
These interventions are planned at specific stages of the project, when the consortium is carrying out critical tasks. At these moments, the contribution of external advisors plays a key role in consolidating progress and ensuring alignment with project objectives.
...
:::landscape
![](../assets/Gantt/EBAGantt.png){#fig-EBA fig-align="center" width="95%"}
:::
...
The External Board Advisory (EBA) will play a central role in guiding and validating the TechTraPlastiCE project throughout its lifecycle. 
The main purpose is to bring together experts in **circular economy, technology transfer between academia and industry, and plastic recycling**, the EBA will ensure that the project’s activities are aligned with both international best practices and the specific socio-economic realities of Latin America.  
...
The purpose of 2025 for EBA will be present the project and exchange first EBA's experiences for all consortium in order to establish a baseline of mutual confidence.
...
Challenges & Opportunities*"" (Prof. Ferran Giones) and "*Circular Grassroots Innovations*" (Prof. Marioa Jose Zapata); giving remarkables insigths in the challenges that TechTraPlastiCE aims to tackle. 


![Participation of Prof. Ferran Giones from University of Sttutgart and Prof. Maria José Zapata from the University of Gotemburg during Kick-off meeting at Nancy, France on March 25-28/2025.](figures/6.1/External-committe.png){#fig-kick width="70%"}
...
The format expected will be joint workshop where HEIs present their findings and local challenges that may involve in-depth advisory and mentoring session with EBA experts to refine collaboration strategies.  
...
1. Give a feedback  on the proposed pilot projects in terms of feasibility, innovation, and regional impact.
...
It would be expected that EBA join in project meetings and (if posible for EBA colombian) presencial conferences in Colombia. 
...
The add value of EBA in this point of the project is to extract **transferable best practices** according their experience to the HEI's, not only from TechTraPlastiCE, but for latin-american HEI's.
This will contribute to the final recommendations report and evetually working for  post-project sustainability strategies.  
