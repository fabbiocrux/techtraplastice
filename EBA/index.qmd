...
## Slide Title {background-iframe="https://techtraplastice.eu/"}

# TechTraPlastiCE Project {.tema-naranja .center}

## Consortium {background-color="#F1F1F1" background-image="figures/Consorcio.png" background-size="30%" background-position="90% 50%"}
