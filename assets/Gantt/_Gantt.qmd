...
format:
  pdf:
    ...
    geometry: margin=2cm, paperheight=28cm, paperwidth=49cm
...
<!-- %%%%%%%%%% Converting to png. %%%%%%%%%%%%
%% magick -density 150 _Gantt.pdf -quality 90 Gantt.png -->
...
\begin{ganttchart}[vgrid,
   ...
   milestone/.append style={fill=Naranja, rounded corners=2pt},
   milestone incomplete/.style={/pgfgantt/milestone, fill=orange},
   milestone label font=\large\bfseries\color{orange},
]{2025-02}{2028-01}
...
\ganttmilestone[]{Participation EBA I}{2026-02} 
...
\ganttmilestone[]{Participation EBA II}{2026-10} 
\ganttnewline[thick, Celeste] 
\\
